...
// ดาวน์โหลดไฟล์แนบ
router.get('/attachment/:id', ensureAuthenticated, async (req, res) => {
  try {
...
// API สำหรับคำนวณค่าธรรมเนียม
router.post('/calculate-fees', ensureAuthenticated, (req, res) => {
  try {
...
router.get('/payment-qr/:id', ensureAuthenticated, async (req, res) => {
  try {
    ...
    // สร้าง QR Code (ตัวอย่างเท่านั้น ในการใช้งานจริงควรใช้บริการจากธนาคารหรือผู้ให้บริการชำระเงิน)
